...
const initialEdgesData: Edge[] = [
  ...
  { id: 'e-prep-6', source: 'clean', target: 'drop-missing-rows', type: 'smoothstep', animated: true, hidden: true, style: edgeStyle, markerEnd: edgeMarker, sourceHandle: 'left', targetHandle: 'bottom' },
